...
// ── Vehicle Modes (13 types) ──
export const VEHICLE_MODES = [
  { key: 'bicycle', label: 'Bicycle', maxWeight: 5, maxL: 50, maxW: 35, maxH: 35, baseFare: 5, icon: '🚲' },
  { key: 'e_bike', label: 'E-Bike', maxWeight: 8, maxL: 50, maxW: 35, maxH: 35, baseFare: 6, icon: '⚡' },
  ...
  { key: 'lorry_24ft', label: '24ft Lorry', maxWeight: 4000, maxL: 720, maxW: 220, maxH: 220, baseFare: 280, icon: '🚛' },
  { key: 'trailer_20ft', label: '20ft Trailer', maxWeight: 10000, maxL: 600, maxW: 240, maxH: 260, baseFare: 180, icon: '🚛' },
  { key: 'trailer_40ft', label: '40ft Trailer', maxWeight: 20000, maxL: 1200, maxW: 240, maxH: 260, baseFare: 350, icon: '🚛' },
